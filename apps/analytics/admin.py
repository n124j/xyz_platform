...
class MarketDataAdmin(admin.ModelAdmin):
    list_display = ("ticker", "security_name", "price_date", "close_price", "volume", "source")
...
class RiskMetricAdmin(admin.ModelAdmin):
    list_display = ("scope", "reference_id", "calculation_date", "var_95_1d", "sharpe_ratio", "max_drawdown")
    list_filter = ("scope",)
...
class BenchmarkReturnAdmin(admin.ModelAdmin):
    list_display = ("benchmark_code", "benchmark_name", "return_date", "daily_return", "index_level")
...
class PerformanceAttributionAdmin(admin.ModelAdmin):
    list_display = ("account_number", "period_start", "period_end", "asset_class", "total_effect")
